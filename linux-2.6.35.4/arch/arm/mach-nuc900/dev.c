...
static struct resource nuc900_ehci_resource[] = {
        [0] = {
...
static struct resource nuc900_ohci_resource[] = {
        [0] = {
...
static struct platform_device nuc900_device_ohci = {
        .name		  = "nuc900-ohci",
        .id		  = -1,
        .num_resources	  = ARRAY_SIZE(nuc900_ohci_resource),
        .resource	  = nuc900_ohci_resource,
        .dev              = {
...
static u64 nuc900_device_udc_dmamask = 0xffffffffUL;
static struct platform_device nuc900_device_usbgadget = {
	...
	.dev              = {
		.dma_mask = &nuc900_device_udc_dmamask,
		.coherent_dma_mask = 0xffffffffUL
	}
};
...
static u64 nuc900_device_fmi_dmamask = 0xffffffffUL;
struct platform_device nuc900_device_fmi = {
	...
	.dev              = {
		.dma_mask = &nuc900_device_fmi_dmamask,
		.coherent_dma_mask = 0xffffffffUL
	}
};
...
struct nuc900_keypad_platform_data nuc900_keypad_info = {
...
struct platform_device nuc900_device_audio_ac97 = {
        .name		= "nuc900-audio-ac97",
        .id		= -1,
...
static struct resource nuc900_i2s_resource[] = {
        [0] = {
                .start = W90X900_PA_ACTL,
                .end   = W90X900_PA_ACTL + W90X900_SZ_ACTL - 1,
                .flags = IORESOURCE_MEM,
...
struct platform_device nuc900_device_audio_i2s = {
        .name		= "nuc900-audio-i2s",
        .id		= -1,
        .num_resources	= ARRAY_SIZE(nuc900_i2s_resource),
        .resource	= nuc900_i2s_resource,
        .dev              = {
                .dma_mask               = &nuc900_device_audio_dmamask,
                .coherent_dma_mask      = -1,
        }
...
/* I2C */
// port 0
static struct resource nuc900_i2c_p0_resource[] = {
        [0] = {
                .start = W90X900_PA_I2C,
                .end   = W90X900_PA_I2C + W90X900_SZ_I2C - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_I2CGROUP,
...
struct platform_device nuc900_device_i2c_p0 = {
        .name		  = "nuc900-i2c-p0",
        .id		  = -1,
        .num_resources	  = ARRAY_SIZE(nuc900_i2c_p0_resource),
        .resource	  = nuc900_i2c_p0_resource,
};

EXPORT_SYMBOL(nuc900_device_i2c_p0);

//port 1
static struct resource nuc900_i2c_p1_resource[] = {
        [0] = {
                .start = W90X900_PA_I2C,
                .end   = W90X900_PA_I2C + W90X900_SZ_I2C - 1,
                .flags = IORESOURCE_MEM,
...
struct platform_device nuc900_device_i2c_p1 = {
        .name		  = "nuc900-i2c-p1",
        .id		  = -1,
        .num_resources	  = ARRAY_SIZE(nuc900_i2c_p1_resource),
        .resource	  = nuc900_i2c_p1_resource,
};
